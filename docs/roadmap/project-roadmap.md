...
| 4 | Structured AI Extraction | Unstructured documents to typed order drafts | IN PROGRESS |
...
| M4B — Typed Models, Prompt Renderer & Fake Provider | NOT STARTED |
| M4C — OrderExtractor & Response Hardening | NOT STARTED |
| M4D — Gemini Provider | NOT STARTED |
| M4E — Cross-Format & Adversarial Robustness | NOT STARTED |
| M4F — Independent Phase 4 Audit & Closeout | NOT STARTED |
